...
```bash
claude mcp add --transport http Web3NS https://webns-production.up.railway.app/mcp
```
...
**Ethereum / Base** returns an unsigned transaction object:
```json
{
  "to": "0x...",
  "data": "0x...",
...
# save the "secret" from the response, execute the transaction, wait 60 seconds
